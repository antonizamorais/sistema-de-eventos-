...
<div class="wrapper">
  ...
  <div id="content">
    ...
    <form class="form" action="" method="POST">
      ...
      <p class="text-center">MEUS DADOS PESSOAIS</p>
      <div class="row">
        <div class="col-lg-10">
          <label>Nome</label>
      ...
      <br>
      <p class="text-center">MEU ENDEREÇO</p>
      <div class="row">   
        <div class="col-lg-6">
      ...
      <br>
      <p class="text-center">MEUS DADOS DE ACESSO</p>
      <div class="row">
        <div class="col-lg-10">
          <label>Email</label>
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-lg-5">
          ...
          <div class="form-group">
            <input type="text" name="tipo" id="tipo" class="form-control" value="<?php echo $tipoUsuario ?>" disabled>
          </div>
          <samp style="color: red"><a href="">Pedir mudança de nível</a></samp>
        </div>
        <div class="col-lg-5">
          <label>Senha</label>
          <div class="form-group">
            <input type="text" name="senha" id="senha" class="form-control" value="<?php echo $senha ?>" disabled>
          </div>
          <samp style="color: red"><a href="recuperar_senha">Mudar senha</a></samp>
        </div>
      </div>
      <br>   
      <div class="row">
        <div class="col-lg-5">
          <input type="submit" name="btnAtualizaUsuario" value="ATUALIZAR" class="btn btn-lg btn-block" style="color: #FFFFFF;">
        </div>
        <div class="col-lg-5">
