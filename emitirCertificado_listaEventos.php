...
<div class="wrapper">
  ...
  <div id="content">
    ...
    ?>
    <h1 style="text-align: center;">Certificados disponíveis para dawload</h1>
    <p>Evento</p>
    <br>
      ...
      <tbody>
        <?php 
          while($rows_evento = mysqli_fetch_array($resultado)){
            ...
            echo"<td><a class='btn' href ='emitircertificados_listaEventos.php?id=$idEvento'>SELECIONAR</a></td>";
            echo "</tr>";
          }
        ?>
      </tbody>
