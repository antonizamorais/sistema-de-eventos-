...
<div class="wrapper">
  ...
  <div id="content">
    ...
    ?>
    <?php
      $buscar_eventos = "SELECT * FROM evento, inscricao_evento, usuarios_cadastrados WHERE cod_evento = id_evento AND cod_usuario = id";
      ...
      <tbody>
        <?php 
          while($rows_evento = mysqli_fetch_array($resultado)){
            ...
            echo "<td>".$data_2e."</td>";
            echo "<td>".$local_e."</td>";
            echo "<td><a class ='btn' href ='inscricao_atividade.php?id=$id_e'>ATIVIDADES</a> <a class ='btn' href ='fazer_credenciamento.php?id=$id_e'>CREDENCIAMENTO</a></td>";
            echo "</tr>";
          }
        ?>
      </tbody>
