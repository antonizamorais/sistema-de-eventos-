...
<body>
  <div class="wrapper">
    ...
    <div id="content">
      ...
      ?>
      <h1 style="text-align: center;">Cadastrar Ambientes da Instituição</h1>
      <br>
      <br>
      <form class="form" action="cadastrar_ambiente.php" method="POST">
        <div class="row">
          <div class="col-lg-3">
        ...
        <div class="row">
          <div class="col-lg-9">
            <button class="btn btn-lg btn-block" type="submit">CADASTRAR AMBIENTE</button>
          </div>
        </div>
      </form>
      <?php 
