  ...
  <div id="content">
    ...
    <form method="POST">
      <p style="text-align: center;">
        Infelismente o evento em que você tentou se increver já atingiu o limite máximo de participantes. Porém você pode aguarda por uma vaga, caso algum usuário inscrito desista de vim ao evento.
